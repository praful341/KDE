    ...
    public class Secure
    {
        ...
        private String dayDifPutPresent()
        {
            ...
            if (useBetween >= 0)
            {
                ...
                else if (totaldays >= 0 && totaldays <= 120) //mayurpc 26/01/2015
                    return Convert.ToString(120 - totaldays); //how many days remaining
                else
            ...
            else
            {
                ...
                if (block == false)
                {
                    ...
                    if (chinstall == "First")
                    {
                        ...
                        {
                            License f1 = new License(appPassword, globalPath);
