...
namespace KDE
{
    public partial class frmRptPaymetPendingDetails : Form
    {
        ...
        public frmRptPaymetPendingDetails()
        {
        ...
        private void Btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtParty_Code.Text!="" && Txt_From_Date.Text!="  /  /" && Txt_To_Date.Text!="  /  /")
                {
                    ...
                    con.Open();
                    str = "SELECT * From Mst_Payment where partyCode='" + txtParty_Code.Text + "' and (billTo between '" + DateTime.Parse(Txt_From_Date.Text).ToString("MM/dd/yyyy") + "' and '" + DateTime.Parse(Txt_To_Date.Text).ToString("MM/dd/yyyy") + "' or payRecDate between '" + DateTime.Parse(Txt_From_Date.Text).ToString("MM/dd/yyyy") + "' and '" + DateTime.Parse(Txt_To_Date.Text).ToString("MM/dd/yyyy") + "')  ORDER BY partyCode ";
