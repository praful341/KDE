...
namespace KDE
{
    public partial class frmRptPaymet : Form
    {
            ...
            try
            {
                ...
                else
                {
                    if (Txt_Party.Text != "")
                    {
                        ...
                        con.Open();
                        str = "select * from Bill_details where Party_Code='" + Txt_Party.Text + "' AND To_date between '" + DateTime.Parse(Txt_From_Date.Text).ToString("MM/dd/yyyy") + "' and '" + DateTime.Parse(Txt_To_Date.Text).ToString("MM/dd/yyyy") + "' ";
                        SqlDataAdapter da = new SqlDataAdapter(str, con);
                        DataSet ds = new DataSet();
                        da.Fill(ds, "Bill_details");

                        //str = "select * from Payment_Details where Party_Code='" + Txt_Party.Text + "' AND Date between '" + DateTime.Parse(Txt_From_Date.Text).ToString("MM/dd/yyyy") + "' and '" + DateTime.Parse(Txt_To_Date.Text).ToString("MM/dd/yyyy") + "' ";
                        ...
                        {
                            frmRptPaymetViewer obj = new frmRptPaymetViewer();
                    ...
                    if (Txt_Party.Text == "")
                    {
                        string str;
                        con.Open();
                        str = "select * from Bill_details where Com_Code='" + Txt_Com_Code.Text + "' AND To_date between '" + DateTime.Parse(Txt_From_Date.Text).ToString("MM/dd/yyyy") + "' and '" + DateTime.Parse(Txt_To_Date.Text).ToString("MM/dd/yyyy") + "' ";
                        SqlDataAdapter da = new SqlDataAdapter(str, con);
                        DataSet ds = new DataSet();
                        da.Fill(ds, "Bill_details");
